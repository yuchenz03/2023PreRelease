#Bomba- Have a 'bomb' that can remove or 'blow-up' a block in a 'blocked cell', 
#but costs you some of your score (minus some points)

## NOT FINISHED ##

#Each player has 3 bombs. Each bomb costs 5 points.
